...
\begin{abstract}
    This study delves into the global trade disruptions and industrial restructuring triggered by the U.S. "Reciprocal Tariffs" policy since the 2020s. Centering on five core research directions, it employs various mathematical modeling techniques including panel data econometrics, Logit choice models, dynamic simulation, and game theory, integrating authoritative trade, economic, and industrial data from 2017 to 2025 to quantify policy impacts and predict development trends.

For the first research direction, a two-stage modeling framework is constructed. First, a log-log panel data model is used to estimate the price elasticity of soybean import demand (corrected to -1.02 after adjusting for exogenous shocks such as African Swine Fever), followed by the establishment of a tariff gradient simulation engine to simulate the trade redistribution effect within different tariff ranges. Results indicate that an increase in U.S. tariffs will lead to a decline in its soybean export volume, with Brazil as the main substitute absorbing most of the diverted demand, while Argentina’s gain is limited due to logistical and production capacity constraints.

Regarding the second research direction, a multi-dimensional analytical framework integrating a supply-side multi-echelon cost minimization model and a demand-side Logit market allocation model is built, incorporating key variables such as Mexican transshipment costs, fixed costs of U.S. local production, and price elasticity of demand (calibrated to -3.0). Simulations show that when the additional tariff on Japanese automobiles is relatively low, Japan will prioritize transshipment via Mexico to avoid trade barriers; when the additional tariff reaches a certain level, U.S. local production becomes the optimal strategy (localization rate exceeding 75%). However, this restructuring will push up the average price of U.S. automobiles, leading to a contraction in total market demand and triggering downstream employment risks.

In addressing the third research direction, a "Security-Efficiency" equilibrium model is established to balance national security goals (supply chain autonomy) and economic efficiency (inflation control), dividing the chip market into high-end, mid-end, and low-end categories. Simulations of two policy scenarios (Trump: high tariffs without subsidies; Biden: moderate tariffs with high subsidies) reveal that under the Trump policy, the security score of high-end chips is relatively low, while low-end chips face high inflation without achieving industrial reshoring; the Biden policy, on the other hand, improves the security score and controls inflation in the mid-end market, confirming that subsidies are more effective than tariffs for technology-intensive industries.

For the fourth research direction, a dynamic difference-in-differences revenue model is constructed, incorporating short-term and medium-to-long-term import demand elasticities (calibrated based on 2025 import data and supply chain leakage effects). Predictions for 2025-2028 show a trend of "short-term surge and long-term decline": tariff revenue will reach its peak in 2025 with a significant net increase, but the subsequent import tax base will continue to shrink; the cumulative net revenue gain over four years is considerable, yet long-term revenue growth will be constrained by the contraction in import volume.

Regarding the fifth research direction, a multiple linear regression model is constructed to quantify the comprehensive impact of tariff retaliatory measures (such as China’s export controls on rare earths and lithium, and agricultural product tariffs), with core variables including reshoring investment, lithium/rare earth costs, and agricultural export value. Empirical results show that the rise in lithium and rare earth costs and the decline in agricultural exports form a significant negative drag, offsetting the positive effect of tariffs on manufacturing reshoring, indicating that the "Reciprocal Tariffs" policy is unlikely to effectively promote manufacturing reshoring in the short to medium term.

Finally, the model is validated using historical trade data, and robustness tests (normal residual distribution, no significant autocorrelation) are conducted. This study provides quantitative references for countries to formulate tariff response strategies and safeguard industrial interests, as well as insights for maintaining the multilateral trading system. The limitation of the model lies in the failure to incorporate sudden geopolitical shocks; in the future, cross-domain variables such as climate policies can be added to enhance the comprehensiveness of the model.
...
\begin{enumerate}
    ...
    \item Exchange rates fluctuate within a moderate range; PPP approximately holds unless explicitly modeled.
...
Shock B & 25\% & 31,040 & 29,150 & \textbf{24,900} & \textbf{U.S. Reshoring} \\
\bottomrule
\end{tabular}
...
As illustrated in Figure \ref{fig:supply_chain_reconfig}, the supply chain undergoes a regime shift.
\begin{itemize}
